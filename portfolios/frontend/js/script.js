...
function getPlaceholderIcon(projeto) {
  ...
  if (techs.includes('vue.js') || techs.includes('vue')) return 'fa-vuejs';
  if (techs.includes('javascript')) return 'fa-js';
  if (techs.includes('css')) return 'fa-css3-alt';
  if (techs.includes('html')) return 'fa-html5';
  if (techs.includes('api')) return 'fa-plug';

  // extras comuns
  if (techs.includes('design system')) return 'fa-swatchbook';
  if (techs.includes('spa')) return 'fa-layer-group';
  if (techs.includes('auth') || techs.includes('autenticação')) return 'fa-user-shield';
  if (techs.includes('charts') || techs.includes('gráficos')) return 'fa-chart-column';
  if (techs.includes('forms') || techs.includes('formulários')) return 'fa-rectangle-list';
